...
for dim in dims:
    ...
    model_save_path = os.path.join(dim_dir, "best_model.pt")
    scaler_save_path = os.path.join(dim_dir, "best_scaler.pkl")
    ...
    print(f"💾 Saved best scaler to: {scaler_save_path}")


    # ================================
    #  predicting hidden data labels
    # ================================
...
# compute total time consumed
total_seconds = time.time() - global_start_time
hours = total_seconds // 3600
minutes = (total_seconds % 3600) // 60
seconds = total_seconds % 60

print(f"⏱️ total time consumed: {int(hours)}hours {int(minutes)}minutes {seconds:.2f}seconds")
